...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $param = [[
            ...
            "body" => "日本人が古くから親しんできた香辛料の中で，寿司や刺身に欠かせない薬味といえばわさびである。わさびの細菌に対する抗菌効果を確かめるため，蒸散暴露（気相法）により大腸菌と黄色ブドウ球菌を用いて実験を行った。暴露する温度条件を4℃，室温（25℃），35℃で抗菌効果を比較すると，チューブ入り加工工わさび，生わさびのいずれも暴露温度が35℃時に抗菌効果が高かった。わさびに7日間継続的に暴露し続けた結果，生わさびは途中で菌の発育がみられたが，チューブ入り加工わさびは菌の発育はみられず，細菌に対する増殖抑制と共に殺菌効果があることがわかった。菌数減少の推移を定量的に測定したところ，暴露開始5時間後から徐々に菌数が減少し48時間後には生菌は全く認められなかった。わさびの主な抗菌成分は揮発性のアリルイソチオシァネートといわれる。この実験からも寒天培地に触れさせず蒸気で接触させる方法で抗菌効果が強く認められたと考えられる。"
            ],
            [
